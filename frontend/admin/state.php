...
<body>
  ...
  <?php include '../components/sidebar.php'; ?>
    ...
    <div class="main-container" style="max-width: 900px; margin: 0 auto;">
      ...
      <!-- Edit State Modal -->
      <div id="editStateModal" class="modal" style="display:none; position:fixed; top:0; left:0; width:100vw; height:100vh; background:rgba(0,0,0,0.3); align-items:center; justify-content:center; z-index:9999;">
        <div class="modal-content" style="background:#fff; padding:32px 28px; border-radius:12px; max-width:500px; width:100%; position:relative;">
          <span id="closeEditStateModal" style="position:absolute; top:12px; right:18px; font-size:1.5rem; cursor:pointer;">&times;</span>
          <h2 style="margin-top:0; color:#2563eb; font-size:1.5rem; margin-bottom:18px;">Edit State</h2>
          <form id="editStateForm" enctype="multipart/form-data" style="display:flex; flex-direction:column; gap:18px;">
            <input type="hidden" name="id" id="editStateId" />
            <div>
              <label style="font-weight:600; color:#374151; margin-bottom:8px; display:block; font-size:0.95rem;">State Name:</label>
              <input type="text" name="name" id="editStateName" required style="width:100%; padding:10px 14px; border-radius:8px; border:2px solid #e5e7eb; font-size:1rem;" />
            </div>
            <div>
              <label style="font-weight:600; color:#374151; margin-bottom:8px; display:block; font-size:0.95rem;">State Code:</label>
              <input type="text" name="code" id="editStateCode" required style="width:100%; padding:10px 14px; border-radius:8px; border:2px solid #e5e7eb; font-size:1rem;" />
            </div>
            <div>
              <label style="font-weight:600; color:#374151; margin-bottom:8px; display:block; font-size:0.95rem;">Country:</label>
              <select name="country" id="editStateCountry" class="custom-select" required></select>
            </div>
            <div>
              <label style="font-weight:600; color:#374151; margin-bottom:8px; display:block; font-size:0.95rem;">Description:</label>
              <textarea name="description" id="editStateDescription" required rows="3" style="width:100%; padding:10px 14px; border-radius:8px; border:2px solid #e5e7eb; font-size:1rem;"></textarea>
            </div>
            <div>
              <label style="font-weight:600; color:#374151; margin-bottom:8px; display:block; font-size:0.95rem;">State Logo:</label>
              <input type="file" name="logo" id="editStateLogo" accept="image/*" />
            </div>
            <div>
              <label style="font-weight:600; color:#374151; margin-bottom:8px; display:block; font-size:0.95rem;">State Map:</label>
            ...
            <div style="display:flex; gap:12px; margin-top:10px;">
              ...
              <button type="button" id="cancelEditStateBtn" style="background:#6b7280; color:#fff; border:none; border-radius:8px; padding:12px 28px; font-size:1.1rem; font-weight:600; cursor:pointer;">Cancel</button>
            </div>
          </form>
        </div>
      </div>
