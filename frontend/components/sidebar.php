...
$sidebarMenu = [
  ...
  [
    ...
    'children' => [
      ['label' => 'Stream', 'href' => 'stream.html'],
      ['label' => 'Degree Type', 'href' => 'degreetype.html'],
      ['label' => 'Course Name', 'href' => 'coursename.html'],
      ['label' => 'Sub-Course Branch', 'href' => 'subcoursebranch.html'],
      ['label' => 'Course Duration', 'href' => 'courseduration.html'],
      ['label' => 'Affiliation Name', 'href' => 'affiliationname.html'],
      ['label' => 'Approved Through', 'href' => 'approvedthrough.html'],
      ['label' => 'Exam Through', 'href' => 'examthrough.html'],
      ['label' => 'Ranking', 'href' => 'ranking.html'],
      ['label' => 'Ownership', 'href' => 'ownership.html'],
      ['label' => 'College-Facilities', 'href' => 'college-facilities.html'],
    ],
  ],
  [
    'label' => 'College Master',
    'icon' => 'fa-university',
    'pages' => ['addcollege', 'addcollege', 'datadisplay', 'collegeview'],
    'children' => [
  ...
  [
    'label' => 'Exam Master',
    'icon' => 'fa-file-alt',
    'pages' => ['examlevel', 'addexam', 'addexam'],
    'children' => [
